...
public class EscapeSequences {
    ...
    public static final String SET_BG_COLOR_DARK_BLUE = SET_BG_COLOR + "111m";
    public static final String SET_BG_COLOR_LIGHT_BROWN = SET_BG_COLOR + "223m";
    public static final String SET_BG_COLOR_DARK_BROWN = SET_BG_COLOR + "138m";
